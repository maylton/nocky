...
- Dialog layout, scrolling and stream-source controls were validated manually.
- Reordering, enabling/disabling, final-source protection and reset now work through the native dialog.
- Preferences persist and the privacy-safe diagnostic remains limited to non-sensitive stream metadata.
