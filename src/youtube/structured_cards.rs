...
fn youtube_card(
    ...
    artwork_trace::trace_item(
        "structured_cards_youtube_card_before_cached_cover",
        section_title,
        item,
        None,
        "before item.cached_cover()",
    );
    if let Some(path) = item.cached_cover() {
        artwork_trace::trace_item(
            "structured_cards_youtube_card_using_cover",
            section_title,
            item,
            Some(path),
        ...
        artwork_trace::trace_item(
            "structured_cards_youtube_card_placeholder",
            section_title,
            item,
            None,
            "item.cached_cover() returned None",
        );
