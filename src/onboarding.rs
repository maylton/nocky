...
fn copy(language: AppLanguage) -> Copy {
    match language {
        AppLanguage::Portuguese => Copy {
            ...
            source_body: "Escolha a fonte principal da biblioteca. Seu histórico recente poderá reunir itens locais e do YouTube Music.",
            ...
            learning_option_body: "Use o histórico salvo neste dispositivo para criar o carrossel Ouvidos recentemente com faixas, álbuns e playlists. Faixas interrompidas podem ser retomadas pelo próprio card.",
            learning_privacy_note: "Seu histórico permanece neste dispositivo. O carrossel aparece depois que você começa a ouvir e pode ser ocultado em Configurações → Reprodução e Home.",
        ...
        AppLanguage::English => Copy {
            ...
            source_body: "Choose the primary library source. Recent activity can still include both local items and YouTube Music.",
            ...
            learning_option_body: "Use history stored on this device to build the Recently listened carousel with tracks, albums and playlists. Interrupted tracks can resume directly from their card.",
            learning_privacy_note: "Your history stays on this device. The carousel appears after you start listening and can be hidden in Settings → Playback and Home.",
        ...
        AppLanguage::Spanish => Copy {
            ...
            source_body: "Elige la fuente principal de la biblioteca. La actividad reciente puede incluir elementos locales y de YouTube Music.",
            ...
            learning_option_body: "Usa el historial guardado en este dispositivo para crear el carrusel Escuchados recientemente con canciones, álbumes y playlists. Las canciones interrumpidas pueden retomarse desde su tarjeta.",
            learning_privacy_note: "Tu historial permanece en este dispositivo. El carrusel aparece después de empezar a escuchar y puede ocultarse en Configuración → Reproducción e inicio.",
