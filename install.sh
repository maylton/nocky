...
install_file 0755 "helpers/nocky_youtube_playlist_create.py" "${HELPER_DIR}/nocky_youtube_playlist_create.py"
...
install_file 0644 "helpers/nocky_playlist_mutations.py" "${HELPER_DIR}/nocky_playlist_mutations.py"
...
install_file 0644 "docs/YOUTUBE_PLAYLIST_CREATION.md" "${DOC_DIR}/YOUTUBE_PLAYLIST_CREATION.md"
